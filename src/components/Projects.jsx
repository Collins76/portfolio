      ...
      {type === 'dashboard' && <>
        ...
        {[85, 175, 265, 355].map((x, i) => (
          <g key={i}>
            ...
            <rect x={x + 8} y="62" width="50" height="5" rx="2" fill="#1E293B" />
          </g>
        ))}
      ...
      {type === 'kpi' && <>
        {[10, 105, 200, 295].map((x, i) => (
          <g key={i}>
            ...
            <rect x={x + 10} y="68" width="60" height="6" rx="2" fill="#1E293B" />
      ...
      {type === 'powerbi' && <>
        ...
        {[10, 105, 200, 295].map((x, i) => (
          <g key={i}>
            ...
            <rect x={x + 10} y="94" width="55" height="5" rx="2" fill="#1E293B" />
          </g>
        ))}
    ...
    >
      <motion.div
        ...
        className="relative max-w-3xl w-full max-h-[90vh] overflow-y-auto
          rounded-2xl border border-white/10 bg-[#080C18] p-0 shadow-2xl shadow-black/50"
      >
          ...
          {projects.map((p, i) => (
            ...
            >
              <div className="relative h-full flex flex-col rounded-2xl overflow-hidden
                border border-white/[0.06] bg-[#080C18] hover:border-white/[0.12]
